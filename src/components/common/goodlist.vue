<template>
	<div class="shoplist_container">
		<ul v-load-more="loaderMore" v-if="goodListArr.length" type="1">
			<router-link :to="{path: 'shop', query:{geohash, id: item.id}}" v-for="item in goodListArr" tag='li' :key="item.id" class="shop_li">
				<section>
...
import {getFoods,getFoodsCount} from 'src/service/getData'
    ...
    async getFoods(){
      ...
      // })
		...
		async loaderMore(){
			...
			this.hideLoading();
			this.goodListArr = [...this.goodListArr, ...res];
