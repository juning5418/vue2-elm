 <template>
    <section class="cart_module">
        <section v-if="!goods.specifications.length" class="cart_button">
            <transition name="showReduce">
                <span @click="removeOutCart(goods.category_id, goods.item_id, goods.specfoods[0].food_id, goods.specfoods[0].name, goods.specfoods[0].price, '', goods.specfoods[0].packing_fee, goods.specfoods[0].sku_id, goods.specfoods[0].stock)" v-if="foodNum">
                    <svg>
            ...
            <svg class="add_icon" @touchstart="addToCart(goods.category_id, goods.item_id, goods.specfoods[0].food_id, goods.specfoods[0].name, goods.specfoods[0].price, '', goods.specfoods[0].packing_fee, goods.specfoods[0].sku_id, goods.specfoods[0].stock, $event)">
        ...
        <section v-else class="choose_specification">
            <section class="choose_icon_container">
                ...
                <span class="show_chooselist" @click="showChooseList(goods)">选规格</span>
            </section>
        </section>
    </section>
</template>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            foodNum: function (){
                let category_id = this.goods.category_id;
                let item_id = this.goods.item_id;
